 ...
 */
	...
	private ArrayList<Tuple<Person,Vehicle>> getMinWeightPersonAndVehicle(HashMap<Double,TCSMode>modesDetails,HashMap<Double,String> activityDetails,PopulationFactory populationFactory, VehiclesFactory vehiclesFactory){
...
//				}
	...
	public ArrayList<Tuple<Person,Vehicle>> getClonedVehicleAndPersons(PopulationFactory populationFactory, VehiclesFactory vehiclesFactory,HashMap<Double,String>activityDetails,HashMap<Double,TCSMode>modesDetails){
		ArrayList<Tuple<Person,Vehicle>> personsAndVehicles=new ArrayList<>();
		if(this.trips.size()==0) {
			return personsAndVehicles;
		}
		personsAndVehicles.addAll(this.getMinWeightPersonAndVehicle(modesDetails,activityDetails,populationFactory,vehiclesFactory));
		for(TCSTrip trip:this.trips.values()) {
